...
func (_m *ProductRepository) Create(_a0 context.Context, product *models.Product) error {
...
func (_c *ProductRepository_Create_Call) Run(run func(_a0 context.Context, product *models.Product)) *ProductRepository_Create_Call {
...
func (_c *ProductRepository_Create_Call) RunAndReturn(run func(context.Context, *models.Product) error) *ProductRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ProductRepository) GetByID(_a0 context.Context, id string) (*models.Product, error) {
	ret := _m.Called(_a0, id)
...
func (_c *ProductRepository_GetByID_Call) RunAndReturn(run func(context.Context, string) (*models.Product, error)) *ProductRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// Search provides a mock function with given fields: _a0, productType
func (_m *ProductRepository) Search(_a0 context.Context, productType string) ([]*models.Product, error) {
...
func (_c *ProductRepository_Search_Call) Return(_a0 []*models.Product, _a1 error) *ProductRepository_Search_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ProductRepository_Search_Call) RunAndReturn(run func(context.Context, string) ([]*models.Product, error)) *ProductRepository_Search_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: _a0, productToUpdate
func (_m *ProductRepository) Update(_a0 context.Context, productToUpdate *models.Product) error {
...
func (_c *ProductRepository_Update_Call) Run(run func(_a0 context.Context, productToUpdate *models.Product)) *ProductRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*models.Product))
	})
	return _c
...
func (_c *ProductRepository_Update_Call) RunAndReturn(run func(context.Context, *models.Product) error) *ProductRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
